    ...
    return (
        <div className=' sm:flex sm:justify-center'>
            <div className=' sm:w-[30rem] text-[#DAD9EF] px-3 text-[20px] md:text-[23px] mt-10'>
                    ...
                    <form className=' flex flex-col gap-6'>
                        ...
                        <div className="rememberme flex flex-wrap justify-between text-[16px] md:text-[18px] items-center gap-2">
                            <div className='flex items-start gap-2'>
                                <input type="checkbox" name="remember" id="remember" className=' rounded focus:bg-red-400 w-4 h-4 text-blue-800 mt-1' />
                                <label htmlFor="remember" className=' '>I have read and accept the mNivesh  <span className=' text-[#5A51DF]'>Terms & Conditions</span> and <span className=' text-[#5A51DF]'>Privacy Policy</span></label>
                            </div>
                        </div>

                        <button style={{transition:"0.5s"}} type='submit' className=' py-[10px] px-[18px] text-base rounded bg-[#332D8E] hover:bg-[#231e69] border-[1px] border-solid border-blue-500'>Create Your Account</button>
                    </form>
                </div>
                ...
                <div className=" my-7 loginoptions text-center flex text-[15px] md:text-[16px] flex-col gap-6">
                ...
                <div className="dontahveanaccount  my-5">
                    <p className=' text-[16px] md:text-[18px]'>Already have an account? <span className=' text-[#5A51DF]'>
                        <Link to='/login'>
                            Login
                        </Link>
                    </span></p>
